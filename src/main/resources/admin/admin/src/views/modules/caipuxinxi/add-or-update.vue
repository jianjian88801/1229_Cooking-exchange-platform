    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="菜谱分类" prop="caipufenlei">
          <el-select v-model="ruleForm.caipufenlei" placeholder="请选择菜谱分类">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="烹饪时长" prop="pengrenshizhang">
          <el-input v-model="ruleForm.pengrenshizhang" 
              placeholder="烹饪时长" clearable  :readonly="ro.pengrenshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="烹饪时长" prop="pengrenshizhang">
              <el-input v-model="ruleForm.pengrenshizhang" 
                placeholder="烹饪时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.nandu = true;
          ...
          if(o=='pengrenshizhang'){
            this.ruleForm.pengrenshizhang = obj[o];
	    this.ro.pengrenshizhang = true;
            continue;
          }
          if(o=='tupian'){
	...
	this.ruleForm.caipinjieshao = this.ruleForm.caipinjieshao.replace(reg,'../../../springbooted1p6/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
